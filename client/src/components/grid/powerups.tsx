...
interface PowerupsComponentProp {funds:number}

const PowerupsComponent: React.FC<PowerupsComponentProp> = ({funds}) => {
  return <div className="flex flex-col p-4">
    <div className="space-x-1 align-center justify-center flex flex-row"><FundsIcon/><p className="text-bold text-lg text-slate-100">{funds}</p></div>
