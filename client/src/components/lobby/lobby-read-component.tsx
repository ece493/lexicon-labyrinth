...
const LobbySettingsAdminComponent: React.FC<LobbyProps> = ({ ...p }) => {
    return (
        <div className="m-0 h-auto w-full">
            ...
            <div className="m-0 flex flex-col w-full py-1">
                <p className="m-0 text-slate-100">Number of Lives</p>
                <input value={p.lobby.max_lives} type="number" className="m-0 p-1 text-xl rounded-xl"></input>
            </div>
            <div className="m-0 flex flex-col w-full py-1">
                <p className="m-0 text-slate-100">Turn Timer</p>
                <input value={p.lobby.timer_setting} type="number" className="m-0 p-1 text-xl rounded-xl"></input>
            </div>
            <div className="m-0 flex flex-col w-full py-1">
                <p className="m-0 text-slate-100">Board Width</p>
                <input value={p.lobby.board_size[0]} type="number" className="m-0 p-1 text-xl rounded-xl"></input>
            </div>
        </div>
    );
}
