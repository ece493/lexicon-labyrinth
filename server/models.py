...
class Lobby(object):
    ...
    def broadcast_lobby_settings(self) -> None:
        if self.broadcast_func:
            ...
            print(
                f"Broadcasting new lobby settings to all players within lobby {self.lobby_id}: {lobby_settings_message}")
...
class Player(object):
    ...
    def send_message(self, message) -> None:
        ...
        if self.send_func:
            print(
                f"Player with id {self.player_id} is sending a message to the associated websocket for this connection: {message}")
